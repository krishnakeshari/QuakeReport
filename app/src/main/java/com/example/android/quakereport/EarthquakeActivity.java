...
public class EarthquakeActivity extends AppCompatActivity implements LoaderCallbacks<ArrayList<Earthquake>> {
    ...
    //private static final String USGS_REQUEST_URL = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&latitude=28.7040590&longitude=77.1024900&maxradiuskm=1000&limit=10";
    ...
    public Loader<ArrayList<Earthquake>> onCreateLoader(int id, Bundle args) {
        // Create a new loader for the given URL by reading Preferences.
